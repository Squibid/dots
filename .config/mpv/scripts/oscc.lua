...
local user_opts = {
  ...
  hidetimeout = 1000000000,   -- duration in ms until the OSC hides if no
  -- mouse movement. enforced non-negative for the
  -- user, but internally negative is "always-on".
  fadeduration = 60,          -- duration of fade out in ms, 0 = no fade
  deadzonesize = 0,           -- size of deadzone
  minmousemove = 9000,        -- minimum amount of pixels the mouse has to
      ...
      function (element) mp.commandv("seek", get_slider_value(element),
        ...
        if user_opts.volseekbar then
          ...
          ne.content = function ()
            ...
            -- TODO fix cache timestamp overlaping time
            -- return (min > 0 and
